...
(function (Pedido) {
    class ModalPedido {
        constructor() {
            ...
            this._logica = new Pedido.ModalPedidoLogica(this._carrinhoCompras);
                        ...
                        <div class="modal-content">
                            ...
                            <form id="form-order">
                                <div class="modal-body form-control">
                                    ${this._carrinhoCompras.pedido.obterProdutos().map((produtoSelecionado) => this._item.view(produtoSelecionado)).join('')}                       
                                    <div>
    ...
    Pedido.ModalPedido = ModalPedido;
})(Pedido || (Pedido = {}));
